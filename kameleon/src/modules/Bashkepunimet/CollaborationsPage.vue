          ...
          <v-data-table v-model:search="search" :items="companies">
            ...
            <template v-slot:[`item.image`]="{ item }">
              <v-card class="my-2" elevation="2" rounded>
                <v-img
                  :src="`assets/companies/${item.image}`"
                  height="64"
                  cover
                ></v-img>
              </v-card>
            ...
            <template v-slot:[`item.collaborationDate`]="{ item }">
              <div>{{ item.collaborationDate }}</div>
            </template>
          </v-data-table>
        </v-card>
      </CenteredContainer>
